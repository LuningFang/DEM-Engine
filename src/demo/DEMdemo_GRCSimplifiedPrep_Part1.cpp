...
int main() {
    ...
    std::vector<double> scales = {0.014, 0.0075833, 0.003, 0.002, 0.0017};
    ...
    std::vector<double> weight_perc = {0.1700, 0.2100, 0.3300, 0.2100, 0.0800};
    ...
    out_dir += "/DemoOutput_GRCPrep_Simplified_Part1";
